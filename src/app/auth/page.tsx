...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral pt-20">
      <div className="w-full max-w-sm p-8 rounded-xl bg-white border border-border shadow-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-neutral-400 mt-1">VASP Systemic Admin</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <a href="/admin/login" className="block text-center text-sm text-primary hover:underline">
